...
export const configValidationSchema = Joi.object({
  ...
  THROTTLE_LOGIN_TTL: Joi.number().default(900000),
  THROTTLE_LOGIN_LIMIT: Joi.number().default(5),
  THROTTLE_REGISTER_TTL: Joi.number().default(3600000),
  THROTTLE_REGISTER_LIMIT: Joi.number().default(5),
  THROTTLE_FORGOT_PASSWORD_TTL: Joi.number().default(3600000),
  THROTTLE_FORGOT_PASSWORD_LIMIT: Joi.number().default(3),
